...
def parse_args():
    ...
    parser.add_argument(
        '--max-iter', type=int, default=80000, help='Max training iterations.')
    parser.add_argument(
    ...
    parser.add_argument(
        '--center-lr-gen', type=float, default=0.0058, help='Center learning rate.')
    parser.add_argument(
        '--std-lr-gen', type=float, default=0.069, help='Std learning rate.')
    parser.add_argument(
        '--init-std-gen', type=float, default=0.039, help='Initial std.')
    parser.add_argument(
        '--center-lr-disc', type=float, default=0.005, help='Center learning rate.')
    parser.add_argument(
        '--std-lr-disc', type=float, default=0.069, help='Std learning rate.')
    parser.add_argument(
