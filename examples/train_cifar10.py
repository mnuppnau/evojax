...
def parse_args():
    ...
    parser.add_argument(
        '--center-lr', type=float, default=0.00668, help='Center learning rate.')
    parser.add_argument(
        '--std-lr', type=float, default=0.049, help='Std learning rate.')
    parser.add_argument(
        '--init-std', type=float, default=0.049, help='Initial std.')
    parser.add_argument(
...
def main(config):
    ...
    train_task = CIFAR10(batch_size=config.batch_size, test=False)
    
    test_task = CIFAR10(batch_size=config.batch_size, test=True)
