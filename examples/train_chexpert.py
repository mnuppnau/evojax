...
def parse_args():
    ...
    parser.add_argument('--center-lr', type=float, default=0.0025, help='Center learning rate.')  # Adjust as needed
    parser.add_argument('--mini_data', type=int, help='Truncate dataset to this number of examples.')
    parser.add_argument('--std-lr', type=float, default=0.0008, help='Std learning rate.')  # Adjust as needed
    parser.add_argument('--init-std', type=float, default=0.0003, help='Initial std.')  # Adjust as needed
