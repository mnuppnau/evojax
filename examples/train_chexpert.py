...
def parse_args():
    ...
    parser.add_argument('--std-lr', type=float, default=0.09, help='Std learning rate.')  # Adjust as needed
    parser.add_argument('--init-std', type=float, default=0.075, help='Initial std.')  # Adjust as needed
