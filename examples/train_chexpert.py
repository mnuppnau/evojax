...
def parse_args():
    ...
    parser.add_argument('--max-iter', type=int, default=10000, help='Max training iterations.')  # Adjust as needed
    ...
    parser.add_argument('--std-lr', type=float, default=0.003, help='Std learning rate.')  # Adjust as needed
    parser.add_argument('--init-std', type=float, default=0.0005, help='Initial std.')  # Adjust as needed
